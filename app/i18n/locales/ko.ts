...
const ko: PartialLocale = {
  ...
  pricingDetail: {
    ...
    faqTitle: '자주 묻는 질문',
    proHighlightTitle: 'Pro로 할 수 있는',
    proHighlightTitleAccent: '모든 것',
    proHighlightSubtitle: '프롬프트 엔지니어링을 다음 레벨로 끌어올리는 강력한 도구들.',
    highlight1Title: 'AI 리라이트',
    highlight1Desc: 'AI가 프롬프트를 분석하고 개선된 버전을 제안합니다. 복사해서 ChatGPT, Claude, Gemini 등에 바로 활용하세요.',
    highlight2Title: '무제한 분석',
    highlight2Desc: '일일 제한 없이 마음껏 분석하세요. 제한 없이 프롬프트를 반복 개선할 수 있습니다.',
    highlight3Title: '전체 히스토리',
    highlight3Desc: '모든 과거 분석이 저장됩니다. 성장 과정을 추적하고 이전 점수를 언제든 다시 확인하세요.',
    highlight4Title: '광고 없는 경험',
    highlight4Desc: '프롬프트 개선에만 집중하세요. 배너도 없고, 방해도 없습니다.',
    comparisonTitle: '무료 vs Pro',
    comparisonTitleAccent: '한눈에 보기',
    compFeature: '기능',
    compFree: '무료',
    compPro: 'Pro',
    compRow1: '일일 분석 횟수',
    compRow1Free: '최대 10회',
    compRow1Pro: '무제한',
    compRow2: 'PROMPT 차원 점수',
    compRow2Both: '6가지 차원 모두',
    compRow3: 'AI 리라이트 제안',
    compRow4: '분석 히스토리',
    compRow4Free: '제공 안 됨',
    compRow4Pro: '전체 히스토리',
    ...
    compRow7: '대량 분석',
    compRow7Free: '제공 안 됨',
    compRow7Pro: '한 번에 최대 5개',
    testimonialsTitle: '사용자들의',
    testimonialsTitleAccent: '실제 후기',
    testimonial1: 'AI 리라이트 기능을 쓰고 프롬프트 점수가 30점 이상 올랐어요. 이제 ChatGPT에서 항상 더 좋은 결과를 받습니다.',
    testimonial1Author: '마케팅 매니저',
    testimonial2: '분석 히스토리 덕분에 프롬프팅 실력이 얼마나 성장했는지 정확히 추적할 수 있어요. 충분히 값어치 합니다.',
    testimonial2Author: 'AI 리서처',
    testimonial3: '이제 모든 클라이언트 프로젝트에 ScoreMyPrompt를 사용합니다. 내보내기 기능으로 리포트 공유가 너무 쉬워요.',
    testimonial3Author: '프리랜서 컨설턴트',
    bottomCtaTitle: '더 나은 프롬프트를',
    bottomCtaTitleAccent: '작성할 준비 되셨나요?',
    bottomCtaSubtitle: '지금 무료 체험을 시작하세요. 신용카드 불필요.',
    bottomCtaButton: '7일 무료 체험 시작',
    bottomCtaNote: '언제든 해지 가능 · 체험 후 자동 결제 없음',
  },

  // ─── Trial ─────────────────────────────────────
  trial: {
    title: 'Pro 무료 체험',
    subtitle: '24시간 동안 모든 Pro 기능을 경험하세요.',
    activate: '무료 체험 활성화',
    activating: '활성화 중...',
    active: 'Pro 체험 중',
    remaining: '{time} 남음',
    expired: '체험 종료',
    expiredDesc: 'Pro로 업그레이드하여 무제한으로 사용하세요.',
    upgrade: 'Pro로 업그레이드',
    continueWithPremium: '프리미엄으로 계속',
    signUpFirst: '가입 후 체험 가능',
    onceOnly: '1회 한정',

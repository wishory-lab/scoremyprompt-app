...
const en = {
  ...
  trial: {
    title: 'Try Pro Free',
    subtitle: 'Experience all Pro features for 24 hours.',
    activate: 'Activate Free Trial',
    activating: 'Activating...',
    active: 'Pro Trial Active',
    remaining: '{time} remaining',
    expired: 'Trial Ended',
    expiredDesc: 'Upgrade to Pro for unlimited access.',
    upgrade: 'Upgrade to Pro',
    continueWithPremium: 'Continue with Premium',
    signUpFirst: 'Sign up to activate trial',
    onceOnly: 'One-time only',
    noCreditCard: 'No credit card required · No auto-charge · Ends after 24h',
  },
} as const;
